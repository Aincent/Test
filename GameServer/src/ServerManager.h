...
public:
	...
	void RegisterMsg()
	{
		DEF_MSG_ACK_REG_FUN(eGameServer, MSG_SIM_GT2GM_PUSHSERVERID);
		DEF_MSG_ACK_REG_FUN(eGameServer, MSG_SIM_DB2GM_PUSHSERVERID);
		DEF_MSG_ACK_REG_FUN(eGameServer, MSG_REQ_GM2WS_PUSHSERVERID);
		DEF_MSG_ACK_REG_FUN(eGameServer, MSG_REQ_GM2MS_PUSHSERVERID);
	}

	DEF_MSG_ACK_DECLARE_FUN_H(MSG_SIM_GT2GM_PUSHSERVERID);
	DEF_MSG_ACK_DECLARE_FUN_H(MSG_SIM_DB2GM_PUSHSERVERID);
	DEF_MSG_ACK_DECLARE_FUN_H(MSG_REQ_GM2WS_PUSHSERVERID);
	DEF_MSG_ACK_DECLARE_FUN_H(MSG_REQ_GM2MS_PUSHSERVERID);
...
private:
	...
	map<int,Smart_Ptr<SvrItem> > m_gateSvr;  // ����id��Ӧ gateserver,
//	CSimLock m_gateLock;
	map<int,Smart_Ptr<SvrItem> > m_dbSvr;  // ����id��Ӧ��dbserver
//	CSimLock m_dbLock;
	map<int,Smart_Ptr<SvrItem> > m_allSvr;  // gs�����еĵ�server
//	CSimLock m_allLock;
