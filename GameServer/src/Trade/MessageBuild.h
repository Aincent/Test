...
Safe_Smart_Ptr<CommBaseOut::Message> build_message(Safe_Smart_Ptr<CommBaseOut::Message> &message, google::protobuf::Message *content, int messageType = Ack, int timeOut = 5);

Safe_Smart_Ptr<CommBaseOut::Message> build_message(int messageID, google::protobuf::Message *content, int channel, int messageType = Ack, int timeOut = 5);
