...
#ifndef MARRYCARBON_H_
#define MARRYCARBON_H_
...
class CMarryCarbon : public CGameDuplicate
{
public:
	CMarryCarbon(int64 onlyid, int64 charid, int64 paramf, int64 params);
	virtual ~CMarryCarbon();
	...
	void DestoryMarryToWs();

	void SendAwardToOffLine(int64 charid);
private:
	bool m_bIsAward;
};


#endif /* MARRYCARBON_H_ */
