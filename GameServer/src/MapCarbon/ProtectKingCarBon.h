...
#ifndef PROTECTKINGCARBON_H_
#define PROTECTKINGCARBON_H_
...
class CProtectKingCarBon : public CGameDuplicate
{
public:
	CProtectKingCarBon(int64 onlyid, int64 charid, int64 paramf, int64 params);
	virtual ~CProtectKingCarBon();
	...
	void FlushMonster(int node);
	int GetAttriByFactor(int baseAttri,int factor);
	//赢了后的操作
	virtual void Win();
	//副本结束时间到了之后的 操作
	virtual void Over();
